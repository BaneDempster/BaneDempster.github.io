    ...
    var levelData = [
      {
        ...
        gameItems: [
          ...
          { type: "enemy", x: 750, y: groundY - 360 },
          { type: "enemy", x: 1000, y: groundY - 360 },
          { type: "enemy", x: 1500, y: groundY - 360 },
      ...
      },
      {
        ...
        gameItems: [
          ...
          { type: "enemy", x: 500, y: groundY - 360 },
          { type: "enemy", x: 800, y: groundY - 360 },
          { type: "enemy", x: 1200, y: groundY - 360 },
      ...
      },
     {
      name: "Escape Egghead Island",
        ...
        gameItems: [
          ...
          { type: "sawblade", x: 700, y: groundY - 60 },
          { type: "sawblade", x: 900, y: groundY - 30 },
          { type: "reward", x: 1000, y: groundY - 350 },
          { type: "reward", x: 450, y: groundY -360 }, 
          { type: "enemy", x: 550, y: groundY - 360 },
          { type: "enemy", x: 800, y: groundY - 360 },
          { type: "enemy", x: 1400, y: groundY - 360 },
          { type: "endOfLevelMarker", x: 2000, y: groundY - 350 },
        ],
     } 
    ];
