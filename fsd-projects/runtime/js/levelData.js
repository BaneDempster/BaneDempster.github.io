    ...
    var levelData = [
      {
        ...
        gameItems: [
          ...
          { type: "endOfLevelMarker", x: 2500, y: groundY - 75 },
        ],
      },
      {
        ...
        gameItems: [
          ...
          { type: "enemy", x: 800, y: groundY - 60 },
          { type: "enemy", x: 1200, y: groundY - 60 },
          { type: "endOfLevelMarker", x: 2000, y: groundY - 50 },
        ],
      },
      {
        ...
        gameItems: [
          ...
          { type: "reward", x: 1000, y: groundY - 50 },
          { type: "reward", x: 450, y: groundY - 60 },
          { type: "enemy", x: 550, y: groundY - 60 },
          { type: "enemy", x: 800, y: groundY - 60 },
